...
public class Instagram implements Parcelable {
    //pakai parceable untuk memudahkan pemanggilan
    //bikin attribute utk deklarasi
    ...
    //untuk mentransfer data antara komponen aplikasi, seperti antara aktivitas.
    //bertanggung jawab untuk membaca data dari parcel dan menginisialisasi objek Instagram sesuai dengan data yang ada di parcel terse
    //dan cek apakah ada postingan  atau tidak
    ...
    //implementasi parceable utk memasukkan objek ke ig
    //alt+enter
    @Override
