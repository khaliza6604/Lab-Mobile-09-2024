...
public class PostinganFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_posting.setOnClickListener(btn ->{
            ...
            if (konten.isEmpty()) {
                Toast.makeText(getActivity(), "Please fill the content", Toast.LENGTH_SHORT).show();
            } else if (selectedImageUri != null) {
                Instagram instagram = new Instagram("khalissky_", "Khalizatul Jannah", konten, R.drawable.pp, selectedImageUri);
                ...
                // jika gambar tidak dipilih = kosong
                Toast.makeText(getActivity(), "select the photo first", Toast.LENGTH_SHORT).show();
            }
        });
