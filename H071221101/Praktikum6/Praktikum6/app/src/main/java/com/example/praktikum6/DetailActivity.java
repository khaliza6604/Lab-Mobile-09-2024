    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRetryDetail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //hide all the componens when offline
                ...
                // show progressbar for showing that app is reconnecting
                pbOffDetail.setVisibility(View.VISIBLE);
                fetchUserDetails(userId);
                // make and run thread for try reconnect
            }
        });
    }
    ...
    private void fetchUserDetails(int userId) {
        ...
        call.enqueue(new Callback<UserDetailResponse>() {
            ...
            public void onFailure(Call<UserDetailResponse> call, Throwable t) {
                ...
                llDetail.setVisibility(View.GONE);
                isLoading = false;
                // show ui that internet is not connecting
