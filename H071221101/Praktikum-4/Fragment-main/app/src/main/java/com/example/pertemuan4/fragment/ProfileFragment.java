...
public class ProfileFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState); //saat activty dimulai, yang ini akan berjalan terebih dahulu
...
//ditambahkan ke back stack, dapat kembali ke fragment kalau click tombol kembali.