...
public class PostinganAdapter extends RecyclerView.Adapter<PostinganAdapter.ViewHolder> {
    ...
    public PostinganAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.postingan, parent, false); //simpan sementara
    ...
    public void onBindViewHolder(@NonNull PostinganAdapter.ViewHolder holder, int position) {
        ...
        holder.ivDelete.setOnClickListener(v -> {
            ...
            builder.setMessage("Are you sure, you want to delete thos post?");
    ...
    } //metode yang mengembalikan jumlah total item dalam data set (mengembalikan jumlah item dalam ArrayList instagrams)

    public class ViewHolder extends RecyclerView.ViewHolder { //class inner ViewHolder yang bertanggung jawab untuk menyimpan referensi layout dalam setiap item postingan. ViewHolder mempercepat proses pengguliran dan meningkatkan kinerja RecyclerView dengan menyimpan referensi tampilan yang sering digunakan.
